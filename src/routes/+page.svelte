...
<div class="container min-h-screen mx-auto flex justify-center items-center overflow-y-auto">
	<div class="space-y-10 text-center">
		<h2 class="font-bold">Welcome to my world.</h2>
		<!-- Animated Logo -->
		<figure>
		...
		<!-- / -->
		<div class="space-y-2">
			<h4>Seems you've landed on a project...</h4>
			<p>This is a product of my passion for coding and design.</p>
			<p>Feel free to explore and learn more about my work.</p>
		</div>
	</div>
</div>
<div class="bg-blue-500 bg-opacity-20 rounded-lg shadow-md container min-h-screen mx-30 flex flex-col md:flex-row md:grid md:grid-cols-3 gap-x-3 gap-y-6 justify-center items-center overflow-y-auto pl-5 md:px-auto">
